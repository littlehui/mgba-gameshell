...
#elif defined BUILD_GAMESHELL
	mInputBindKey(inputMap, SDL_BINDING_KEY, SDLK_j, GBA_KEY_A);
	mInputBindKey(inputMap, SDL_BINDING_KEY, SDLK_k, GBA_KEY_B);
	mInputBindKey(inputMap, SDL_BINDING_KEY, SDLK_u, GBA_KEY_L);
	mInputBindKey(inputMap, SDL_BINDING_KEY, SDLK_i, GBA_KEY_R);
